...
const Collections = () => {
    ...
    return (
        <React.Fragment>
            <div id="smart-alert-collection" className="container mb-5 mt-5 py-1 ">
            ...
            <div className="col-6 d-none d-lg-block">
                <div className="btn-group border p-1 rounded" role="group" aria-label="Basic radio toggle button group ">
                    ...
                    <div className="col-lg-6 col-md-12 col-sm-12 col-12 text-start"><h3>Watchlist</h3></div>
                    <div className="col-lg-6 col-md-12 col-sm-12 col-12 text-sm-start">
                        <button className='btn btn-primary' onClick={addCollection}>+ Add collection</button>
                      </div>
                    ...
                    {/* <div className="col-lg-6 col-md-12 col-sm-12 col-12  d-lg-none d-sm-block">
                        <div className="row ">
                    ...
                    <div className="col-lg-6 col-md-12 col-sm-12 col-12  my-5 d-lg-none d-sm-block">
                        <div className="row">
